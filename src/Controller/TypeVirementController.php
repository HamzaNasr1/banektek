...
class TypeVirementController extends AbstractController
{
    ...
    public function index(TypeVirementRepository $typeVirementRepository,Request $request, EntityManagerInterface $entityManager,SessionInterface $session): Response
