...
class AgenceController extends AbstractController
{
    ...
    public function index(AgenceRepository $agenceRepository,Request $request, EntityManagerInterface $entityManager,SessionInterface $session): Response
    ...
    #[Route('/map', name: 'app_agence_map', methods: ['GET'])]
    public function indexmap(AgenceRepository $agenceRepository ): Response
    {
        $agences = $agenceRepository->findAll();
       
    
        return $this->render('agence/index_map.html.twig', [
            'agences' => $agences,
    ...
    { if($session->get('id_agent')){
        ...
        $agence->setDataAjout(new \DateTime());      
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Set the longitude and latitude values on the Agence entity
          ...
          return $this->redirectToRoute('app_agence_map', [], Response::HTTP_SEE_OTHER);
        }
